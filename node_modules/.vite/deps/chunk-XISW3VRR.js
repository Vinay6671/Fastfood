...
function isReactElement(node2) {
  return (0, import_react9.isValidElement)(node2) && !(0, import_react_is.isFragment)(node2);
}
var supportNodeRef = function supportNodeRef2(node2) {
  return isReactElement(node2) && supportRef(node2);
};
var getNodeRef = Number(import_react9.version.split(".")[0]) >= 19 ? (
  // >= React 19
  function(node2) {
...
function useForceUpdate() {
  const [, forceUpdate] = React36.useReducer((x) => x + 1, 0);
  return forceUpdate;
}
...
function useBreakpoint() {
  ...
  const screensRef = (0, import_react21.useRef)({});
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XISW3VRR.js.map
